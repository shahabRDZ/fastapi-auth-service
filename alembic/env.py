...
# Import the metadata so Alembic can detect model changes
from app.database import Base
from app.models import user  # noqa: F401 – register ORM models with Base
...
async def run_async_migrations() -> None:
    ...
    # Use the sync psycopg2 driver for Alembic (async not needed here)
